...
for plugin in plugins_config:
    ...
    if result_configure.returncode != 0:
        ...
        results.append((name, "Configure", False))
        continue

    if args.configure_only:
        results.append((name, "Configure", True))
...
print(clr("\n" + " Build Summary ".center(50, "="), 34))
if not results:
    print("No plugins were processed.")
else:
    for name, target, success in results:
        status = clr("Success", 92) if success else clr("Failed", 91)
